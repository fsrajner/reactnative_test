        ...
        return (
            <View style={styles.container}>
                <View style={styles.infoContainer}>
                    <Image source={{ uri: this.props.data.author.thumbnail }}
                        style={styles.image}
                    />
                    <View style={styles.usernameContainer}>
                        <Text> {this.props.data.author.name} </Text>
                ...
                <View style={styles.footer}>
                    <View style={styles.likeCount}>
                        ...
                        <Text style={styles.text}> {this.props.data.up} liked </Text>
                    </View>
                    ...
                    <View>
                        {this.props.data.text ? <View style={styles.captionContainer}>
                            {<Text style={styles.captionText}> {this.props.data.author.name} </Text>}
                            {<Text style={styles.text}
                            >{this.props.data.text}</Text>
                            }
                        </View> : null}
                        <Text style={styles.dateText}> {this.returnDate(this.props.data.create_date).getDate()} {mL[this.returnDate(this.props.data.create_date).getMonth()]} </Text>
                    </View>
                </View>
            </View>
        );
